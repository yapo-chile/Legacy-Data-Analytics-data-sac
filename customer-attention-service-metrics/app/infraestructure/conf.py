...
INI_ZENDESK_API = environ.secrets.INISecrets \
    .from_path_in_env("APP_ZENDESK_API_SECRET")
...
class AppConfig:
    ...
    class ZENDESK_APIConfig:
        """
        ZENDESK_APIConfig Class representing the configuration
        to access the zendesk api
        """
        url: str = INI_ZENDESK_API.secret(name="urlprefix",
                                          default=environ.var())
        user: str = INI_ZENDESK_API.secret(name="user",
                                           default=environ.var())
        password: str = INI_ZENDESK_API.secret(name="password",
                                               default=environ.var())
    ...
    zendesk_api = environ.group(ZENDESK_APIConfig)
